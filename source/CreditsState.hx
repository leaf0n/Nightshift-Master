...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		["Nightshift Squad"],
		['leaf0n',		'leafon',	"Programmer, artist, and composer of Nightshift'",				'https://twitter.com/leaf0n',	0xFFF73838],
		['golzay',		'golzay',	"Emotional Support'",					'https://twitter.com/G0LZAY',	0xFFFFBB1B],
		['cyan',			'wade',			"Creator of AJAF'",					'https://gamejolt.com/games/1979/444916',			0xFF53E52C],
		['DirectDoggo',			'waffledog',		"Creator of DSaF (wishlist dialtown on steam)'",					'https://store.steampowered.com/app/1035990/Dialtown_Phone_Dating_Sim/',		0xFFFFFDD0],
		[''],
		['Psych Engine Team'],
